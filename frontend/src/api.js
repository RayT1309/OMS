...
export const api = {
  ...
  bookOutOffender: (id, movement) => request(`/offenders/${id}/movements`, { method: 'POST', body: JSON.stringify(movement) }),
  bookInOffender: (id, movementId) => request(`/offenders/${id}/movements/${movementId}/return`, { method: 'POST' }),
